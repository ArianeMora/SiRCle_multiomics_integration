...
__author__ = 'Ariane Mora and Christina Schmidt'
__version__ = '0.0.1'
__title__ = 'SiRCle_multiomics_integration'
__url__ = ''
...
# Sitemap settings
html_baseurl = 'https://github.com/ArianeMora/SiRCle_multiomics_integration'
