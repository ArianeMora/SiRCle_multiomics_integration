...
dcpg = os.path.join(input_dir, f'{cancer}_filtered_DMC_CpG_Late.csv')
...
cpg_samples = cpg_samples[cpg_samples['Stage'] == 'Late']
...
filtered_dcpg.to_csv(os.path.join(input_dir, f'{cancer}_filtered_DCpG_Late.csv'), index=False)
